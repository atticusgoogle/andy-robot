...
(function () {
  ...
  const BOM_DATABASE = [
    ...
    },
    {
      ...
      sourcing: 'Raspberry Pi Camera 3 Wide + 22-pin mini cable',
    ...
    },
    {
      ...
      sourcing: 'AliExpress / Amazon / Adafruit',
      svgType: 'i2s-mic',
      crucial: true
    },
    {
      ...
      sourcing: 'Adafruit #3006 / generic module',
      svgType: 'amp-purple',
      crucial: true
    },
    {
      ...
      sourcing: 'Electronics surplus / Maker store',
    ...
    },
    {
      ...
      sourcing: 'Pololu / Amazon micro gearmotor pair',
      svgType: 'motor-brass',
      crucial: true
    },
    {
      ...
      sourcing: 'TI DRV8833 breakout board',
      svgType: 'driver-red',
      crucial: true
    },
    {
      id: 'treads',
      name: 'Mini Continuous Rubber Track & Wheel Kit',
      category: 'motion',
      price: 14.00,
      qty: 1,
      specs: 'Dual rubber continuous crawler treads + 6 wheels (drive sprockets & idlers)',
      notes: 'Gives the robot its iconic Toy Story tank crawler silhouette and allows 360° skid steering on desks and floors.',
      sourcing: 'Mini robot tank crawler chassis kit',
    ...
    },
    {
      ...
      sourcing: 'GY-521 breakout module',
      svgType: 'sensor-blue',
      crucial: true
    },
    {
      ...
      sourcing: 'Standard maker LED pack',
      svgType: 'led-red',
      crucial: true
    },
    {
      ...
      sourcing: 'Standard tactile switches',
      svgType: 'tactile-btn',
      crucial: false
    },
    {
      ...
      sourcing: '18650BatteryStore / LiionWholesale',
    ...
    },
    {
      ...
      sourcing: '2S BMS protection board',
      svgType: 'bms-board',
      crucial: true
    },
    {
      ...
      sourcing: 'Drok / Maker 5V 5A buck module',
    ...
    },
    {
      ...
      sourcing: 'Panel mount snap-in rocker',
    ...
    },
    {
      ...
      sourcing: 'Craft store / Amazon clear sphere halves',
    ...
    },
    {
      ...
      sourcing: 'Overture / Polymaker PLA',
    ...
    },
    {
      ...
      sourcing: 'Hardware standoff kit',
      svgType: 'screw-kit',
      crucial: false
    },
    {
      ...
      sourcing: 'Arducam / Adafruit / Raspberry Pi 5 Mini CSI Cable',
      svgType: 'camera-module',
      crucial: true
    },
    {
      ...
      sourcing: 'Standard 2x 18650 series battery box',
      svgType: 'battery-pair',
      crucial: true
    },
    {
      ...
      sourcing: 'TP5100 / 2S USB-C boost charger breakout',
      svgType: 'buck-converter',
      crucial: true
    },
    {
      ...
      sourcing: 'Standard maker jumper wire pack',
      svgType: 'screw-kit',
      crucial: true
    }
  ];
      ...
      return `
        <div class="bom-card ${isAcquired ? 'acquired' : ''}" id="card-${item.id}">
          ...
          <div class="bom-card-footer">
            ...
            <button class="btn btn-secondary btn-sm" onclick="window.inspectComponentById('${item.id}')">Details</button>
          </div>
        </div>
      `;
    }).join('');
